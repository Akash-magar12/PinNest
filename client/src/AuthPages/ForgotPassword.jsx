...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] flex flex-col lg:flex-row">
      {/* Left Image Section */}
      <div className="w-full lg:w-1/2 h-64 lg:h-auto relative overflow-hidden hidden lg:block">
        <img
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200">
            ...
            <form onSubmit={handleForgotPassword} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-black text-white py-3 px-4 rounded-xl font-semibold hover:bg-gray-900 transform hover:scale-[1.02] transition-all duration-200 shadow-lg flex justify-center items-center gap-2"
              >
                {loading ? (
                  <>
