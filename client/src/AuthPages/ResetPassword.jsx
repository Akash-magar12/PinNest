...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] flex flex-col lg:flex-row">
      ...
      {/* Right Form Section */}
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-12">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200">
            ...
            <form onSubmit={handleResetPassword} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full flex justify-center items-center gap-2 bg-black text-white py-3 px-4 rounded-xl font-semibold transition-all duration-200 shadow-lg ${
                  loading
              ...
              <div className="text-center">
                <Link to="/">
                  <button
                    type="button"
                    className="text-sm cursor-pointer text-black hover:underline transition"
                  >
                    Back to login
                  </button>
                </Link>
